  ...
  return (
    <Link href={`/projects/${slug}`}>
      <div className="relative group flex items-start space-x-5">
        <div className="w-40 text-right pt-3 shrink-0">
          <h2 className="text-md text-gray-700 font-semibold">{props.title}</h2> {/* text-sm */}
          <p className="text-sm text-gray-400 mt-1">{props.subtitle}</p> {/* text-xs */}
        </div>
